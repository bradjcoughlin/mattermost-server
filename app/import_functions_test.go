...
func TestImportImportUser(t *testing.T) {
	...
	data = UserImportData{
		...
		UsePostClickOpensThread: ptrStr("true"),
	...
	checkPreference(t, th.App, user.Id, model.PREFERENCE_CATEGORY_ADVANCED_SETTINGS, "feature_enabled_post_click_opens_thread", *data.UsePostClickOpensThread)
